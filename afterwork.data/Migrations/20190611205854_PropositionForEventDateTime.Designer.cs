...
namespace afterwork.data.Migrations
{
    ...
    [Migration("20190611205854_PropositionForEventDateTime")]
    partial class PropositionForEventDateTime
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("afterwork.model.EventDateTimeVoter", b =>
                {
                    b.Property<int>("EventDateTimeVoterId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("PropositionForEventDateTimeId");

                    b.Property<int>("UserId");

                    b.HasKey("EventDateTimeVoterId");

                    b.HasIndex("PropositionForEventDateTimeId");

                    b.HasIndex("UserId");

                    b.ToTable("EventDateTimeVoter");
                });
            ...
            modelBuilder.Entity("afterwork.model.PropositionForEventDateTime", b =>
                {
                    b.Property<int>("PropositionForEventDateTimeId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("PropositionForEventDateTimeId");

                    b.HasIndex("EventId");

                    b.HasIndex("PropositionCreatorUserId");

                    b.ToTable("PropositionForEventDateTime");
                });
            ...
            modelBuilder.Entity("afterwork.model.EventDateTimeVoter", b =>
                {
                    b.HasOne("afterwork.model.PropositionForEventDateTime", "PropositionForEventDateTime")
                        .WithMany("EventDateTimeVoter")
                        .HasForeignKey("PropositionForEventDateTimeId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("afterwork.model.PropositionForEventDateTime", b =>
                {
                    b.HasOne("afterwork.model.Event", "Event")
                        .WithMany("PropositionForEventDateTime")
                        .HasForeignKey("EventId");
